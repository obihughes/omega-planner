...
import { ChevronLeft, ChevronRight, Clock, Folder, CheckCircle } from 'lucide-react';
          ...
          {daysInCalendar.map((date, index) => {
            ...
            return (
              <div
                key={index}
                className={cn(
                  "min-h-[130px] p-3 border-r border-b border-border/50 last:border-r-0 hover:bg-accent/30 transition-colors",
