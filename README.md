...
### Weekly Overview
- Weekly Overview at `/weekly-overview` (main sidebar nav) — collapsible month + week goal summaries; week tabs with week nav and Open Notes; 7×3 weekly goals grid (selected + next + two weeks ahead); daily goals use shared Weekly Goals cards
