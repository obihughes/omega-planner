...
export const appHierarchy: AppMapNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        editHint: 'Wraps PantryProvider + ShoppingProvider.',
      },
      {
        id: 'rec-view',
        label: 'RecipesView',
        kind: 'component',
        path: 'components/recipes/RecipesView.tsx',
      },
      {
        id: 'rec-pantry',
        label: 'PantrySidebar',
        kind: 'component',
        path: 'components/meals/PantrySidebar.tsx',
      },
      {
        id: 'rec-shopping',
        label: 'ShoppingListSidebar',
        kind: 'component',
        path: 'components/meals/ShoppingListSidebar.tsx',
      },
      {
        id: 'rec-ctx-pantry',
        label: 'PantryContext',
        kind: 'context',
        path: 'app/context/PantryContext.tsx',
      },
      {
        id: 'rec-ctx-shopping',
        label: 'ShoppingContext',
        kind: 'context',
        path: 'app/context/ShoppingContext.tsx',
      },
      {
        id: 'rec-hook-recipes',
        label: 'useRecipes',
        kind: 'hook',
        path: 'hooks/useRecipes.ts',
      },
      {
        id: 'rec-hook-pantry',
        label: 'usePantry',
        kind: 'hook',
        path: 'hooks/usePantry.ts',
      },
      {
        id: 'rec-hook-shopping',
        label: 'useShopping',
        kind: 'hook',
        path: 'hooks/useShopping.ts',
      },
      {
        id: 'rec-storage-recipes',
        label: 'recipesStorage',
        kind: 'storage',
        path: 'utils/recipesStorage.ts',
      },
      {
        id: 'rec-storage-pantry',
        label: 'pantryStorage',
        kind: 'storage',
        path: 'utils/pantryStorage.ts',
      },
      {
        id: 'rec-storage-shopping',
        label: 'shoppingStorage',
        kind: 'storage',
        path: 'utils/shoppingStorage.ts',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: 'mod-recipe',
        label: 'RecipeFormModal',
        kind: 'modal',
        path: 'components/modals/RecipeFormModal.tsx',
      },
      {
        id: 'mod-series',
